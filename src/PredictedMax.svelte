...
<div class="flex flex-col justify-center items-center">
  <h1 class="text-2xl py-4">Predicted Max:</h1>
    <div class="flex flex-row py-2 w-3/4 justify-center">
      <h1 class="w-1/2 text-xl text-left">Enter Weight:</h1>
      <input class="text-center text-xl w-1/4 rounded-xl" type="number" bind:value={weight}/>
    </div>
    <div class="flex flex-row py-2 w-3/4 justify-center">
      <h1 class="w-1/2 text-xl text-left">Enter Reps:</h1>
    ...
    <h1 class="text-2xl bg-sky-700 rounded-xl p-6 my-8">
